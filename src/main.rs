...
use tunnel_rs::{client::Client, server::Server};
...
enum Command {
    ...
    Local {
        ...
        #[clap(short, long, env = "TUNNEL_SERVER")]
        to: String,
        ...
        #[clap(short, long, env = "TUNNEL_SECRET", hide_env_values = true)]
    ...
    Server {
        ...
        #[clap(long, default_value_t = 1024, env = "TUNNEL_MIN_PORT")]
        min_port: u16,

        /// Maximum accepted TCP port number.
        #[clap(long, default_value_t = 65535, env = "TUNNEL_MAX_PORT")]
        max_port: u16,
